document.addEventListener("DOMContentLoaded", function () {
    ...
    function isLastCardFullyVisible() {
        ...
        // Check if the last card's right edge aligns with the slider's right edge
        return lastCardRect.right <= sliderWrapRect.right;
    }
    ...
    function handleMove(e) {
        ...
        // Prevent swiping beyond the last card if fully visible
        if (lastCard && isLastCardFullyVisible() && currentTranslate < maxTranslate) {
