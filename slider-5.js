document.addEventListener("DOMContentLoaded", function () {
    ...
    function handleStart(e) {
        ...
        startY = e.type.includes("mouse") ? e.clientY : e.touches[0].clientY; // Use clientY for mouse and touches
    ...
    function handleResize() {
        ...
        sliderWrap.style.transform = `translateX(${prevTranslate}px)`; // Adjust slider position
